...
class ExportService {
  ...
  ///
  /// Tier 1 — Printing.convertHtml() + KaTeX: genuine TeX, branded fonts (online)
  /// Tier 2 — pw.Document + built-in Helvetica: always works offline
  static Future<void> exportChatAsPdf(
    BuildContext context,
    String documentTitle,
    List<ChatMessage> messages,
  ) async {
    // Capture messenger BEFORE any await — safe even if widget later disposes.
...
<div class="footer">Generated by Magnum Opus</div>
